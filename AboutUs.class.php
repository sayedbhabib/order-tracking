		...
		<div class='ewd-otp-about-us-tabs'>
			...
			<ul id='ewd-otp-about-us-tabs-menu'>
				...
				<li class='ewd-otp-about-us-tab-menu-item' data-tab='lite_vs_premium'>
					<?php _e( 'Lite vs. Premium', 'order-tracking' ); ?>
				</li>
			...
			<div class='ewd-otp-about-us-tab ewd-otp-hidden' data-tab='lite_vs_premium'>
				...
				<p><em><?php _e( 'The following table provides a comparison of the lite and premium versions.', 'order-tracking' ); ?></em></p>
				...
				<?php printf( __( '<a href="%s" target="_blank" class="ewd-otp-about-us-tab-button ewd-otp-about-us-tab-button-purchase">Buy Premium Version</a>', 'order-tracking' ), 'https://www.etoilewebdesign.com/license-payment/?Selected=OTP&Quantity=1&utm_source=admin_about_us' ); ?>
